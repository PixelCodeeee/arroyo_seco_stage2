...
console.log("DEBUG: Conectando PrismaClient en la base de datos de Reservation.");
...
prisma.$connect()
    .then(() => console.log('✓ Reservation Service Connected to MySQL database via Prisma ORM'))
    .catch((err) => console.error('❌ Error connecting to database via Prisma:', err.message));

module.exports = { promisePool: prisma, default: prisma, prisma };
